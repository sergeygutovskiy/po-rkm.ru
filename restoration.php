...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/restoration.css">
...
<body>
	...
	<main class="main-container">
		<div class="main-title">Реставрация</div>
		...
		<section class="about-restoration">
			...
			<div class="about-restoration__images">
				<div class="about-restoration__image-container">
					<img class="about-restoration__image" src="img/index-gallery/9.webp">
				</div>
				<div class="about-restoration__image-container">
					<img class="about-restoration__image" src="img/index-gallery/3.webp">
				</div>
			</div>
		</section>
		...
		<section class="about-restoration">
			...
			<div class="about-restoration__images">
				<div class="about-restoration__image-container">
					<img class="about-restoration__image" src="img/index-gallery/2.webp">
				</div>
				<div class="about-restoration__image-container">
					<img class="about-restoration__image" src="img/index-gallery/1.webp">
				</div>
			</div>
		</section>	
